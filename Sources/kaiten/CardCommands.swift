...
struct ListCards: AsyncParsableCommand {
    ...
    func run() async throws {
        ...
        let filter = KaitenClient.CardFilter(
            ...
            firstMovedInProgressAfter: firstMovedInProgressAfter,
            firstMovedInProgressBefore: firstMovedInProgressBefore,
            lastMovedToDoneAtAfter: lastMovedToDoneAtAfter,
            lastMovedToDoneAtBefore: lastMovedToDoneAtBefore,
