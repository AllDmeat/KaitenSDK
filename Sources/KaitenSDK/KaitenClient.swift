...
public struct KaitenClient: Sendable {
    ...
    public struct CardFilter: Sendable {
        ...
        public init(
            ...
            firstMovedInProgressAfter: String? = nil,
            firstMovedInProgressBefore: String? = nil,
            lastMovedToDoneAtAfter: String? = nil,
            lastMovedToDoneAtBefore: String? = nil,
            dueDateAfter: String? = nil,
            dueDateBefore: String? = nil,
            query: String? = nil,
